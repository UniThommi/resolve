...
#define APPLY_SPECIFIC(str) str##_node_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db_0
...
#undef DTYPE_PARAM_input_ndim
    ...
    namespace {
    struct __struct_compiled_op_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db {
        PyObject* __ERROR;
...
PyObject* storage_V5;
    ...
    PyObject* py_V5;
        ...
        __struct_compiled_op_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db() {
        ...
        ~__struct_compiled_op_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db_executor(__struct_compiled_op_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db *self) {
            return self->run();
        }

        static void __struct_compiled_op_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db_destructor(PyObject *capsule) {
            __struct_compiled_op_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db *self = (__struct_compiled_op_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db* struct_ptr = new __struct_compiled_op_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db_executor), NULL, __struct_compiled_op_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_mb2fabc36a6c99164e9bae33ea73d74ef08ce97273daeb824be518ba674a117db(void) {
   import_array();
